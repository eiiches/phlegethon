...
CREATE TABLE Streams (
    namespace_id INT UNSIGNED NOT NULL, -- foreign key (4 bytes)
    ...
    -- Ideally, these ids should reference Labels (label_id). MySQL doesn't support Multi-valued foreign keys.
    ...
    -- CONSTRAINT stream_label_id_fk FOREIGN KEY ((CAST(label_ids AS UNSIGNED ARRAY)) REFERENCES Labels (label_id),
